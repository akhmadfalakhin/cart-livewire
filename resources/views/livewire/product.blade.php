                ...
                <table class="table table-bordered table-hovered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $product->name }}</td>
                            <td><img  style="height:100px; width: 150px" src="{{ asset('storage/images/'.$product->image) }}" alt="product-image" ></td>
                    ...
                    <form wire:submit.prevent="store" action="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="custom-file">
                               <input id="customFile" wire:model="image"  type="file" class="custom-file-input">
